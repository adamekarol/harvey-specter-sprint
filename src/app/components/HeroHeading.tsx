...
export function HeroHeading() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.to(harveyRef.current, { xPercent: -30, ease: "none", scrollTrigger: st });
      gsap.to(specterRef.current,{ xPercent:  30, ease: "none", scrollTrigger: st });
    });
  ...
  return (
    <>
      <p
        ...
        style={{ fontFamily: "monospace", letterSpacing: "0.05em", lineHeight: 1.1 }}
      >
        [ Hello i&apos;m ]
      </p>
      <h1
