...
export function AboutStatementSection() {
  ...
  const spanStyle = { letterSpacing: "-0.08em", lineHeight: 0.84, color: "#c0c0c0" };
  ...
  return (
    <section ref={sectionRef} className="bg-white px-4 min-[900px]:px-8 py-12 min-[900px]:py-[120px]">
      ...
      <div className="flex flex-col gap-0 min-[900px]:gap-[6px]">
        ...
        <div className="text-center min-[900px]:text-left min-[900px]:pl-[12%]">
          <span
            ref={line2Ref}
            className="font-light uppercase whitespace-nowrap text-[8.5vw] min-[900px]:text-[6.67vw]"
            style={spanStyle}
        ...
        <div className="text-center min-[900px]:text-left min-[900px]:pl-[36%]">
          <span
            ref={line3Ref}
            className="font-light uppercase whitespace-nowrap text-[8.5vw] min-[900px]:text-[6.67vw]"
            style={spanStyle}
